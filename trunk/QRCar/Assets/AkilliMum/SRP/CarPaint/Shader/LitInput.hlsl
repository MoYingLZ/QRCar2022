...
//#ifdef _BOTTOMMAP
//    float4 _BottomMap_ST;
//    float4 _BottomBumpMap_ST;
//    float4 _BottomMapDirection;
//    float _BottomMapHeight;
//    float _BottomMapPosition;
//    float _BottomMapScale;
//    float _BottomMapCutoff;
//#endif
...
// #ifdef _SNOWMAP
//     float4 _SnowMap_ST;
//     float4 _SnowBumpMap_ST;
//     float4 _SnowAlphaMap_ST;
//     half4 _SnowColor;
...
//     TEXTURE2D(_SnowAlphaMap);       SAMPLER(sampler_SnowAlphaMap);
// #endif
//#ifdef _BOTTOMMAP
//    TEXTURE2D(_BottomMap);       SAMPLER(sampler_BottomMap);
//    TEXTURE2D(_BottomBumpMap);       SAMPLER(sampler_BottomBumpMap);
//#endif
//#ifdef _DIRTMAP
